    ...
    return (
      <section className={CARD_CLS} aria-label="إصدار وتحديثات النظام">
        ...
        <p className="text-xs text-slate-400">
          الإصدار الحالي: <span dir="ltr" className="font-mono tabular-nums">v2.9.1</span>
        </p>
  ...
  return (
    <section className={CARD_CLS} aria-label="إصدار وتحديثات النظام">
      ...
      <p className="mb-3 text-xs text-slate-400">
        الإصدار الحالي: <span dir="ltr" className="font-mono tabular-nums">v{current ?? '2.9.1'}</span>
      </p>
