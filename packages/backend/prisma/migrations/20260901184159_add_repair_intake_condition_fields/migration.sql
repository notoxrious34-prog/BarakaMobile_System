...
INSERT INTO "new_RepairTicket" ("actualCost", "contactId", "createdAt", "deliveredAt", "depositAmount", "depositPaid", "deviceBrand", "deviceModel", "deviceType", "estimatedCost", "externalCost", "id", "invoiceNumber", "isActive", "notes", "problemDescription", "receivedAt", "relatedTransactionId", "repairType", "status", "technicianName", "ticketNumber", "updatedAt") SELECT "actualCost", "contactId", "createdAt", "deliveredAt", "depositAmount", "depositPaid", "deviceBrand", "deviceModel", "deviceType", "estimatedCost", "externalCost", "id", "invoiceNumber", "isActive", "notes", "problemDescription", "receivedAt", "relatedTransactionId", "repairType", "status", "technicianName", "ticketNumber", "updatedAt" FROM "RepairTicket";
